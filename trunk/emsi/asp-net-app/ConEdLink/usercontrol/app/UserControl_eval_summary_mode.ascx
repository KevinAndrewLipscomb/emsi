<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="UserControl_eval_summary_mode.ascx.cs" Inherits="UserControl_eval_summary_mode.TWebUserControl_eval_summary_mode" %>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td valign="middle">
                    <small><asp:LinkButton ID="LinkButton_new_record" runat="server" CausesValidation="False" Visible="False" OnClick="LinkButton_new_record_Click">Enter brand new eval_summary_mode</asp:LinkButton></small>
                  </td>
                </tr>
              </table>
              <table>
