...
namespace UserControl_analysis_of_region_by_month
  {
  public partial class TWebUserControl_analysis_of_region_by_month: ki_web_ui.usercontrol_class
    {
    public static class UserControl_analysis_of_region_by_month_Static
      {
    ...
    private void InitializeComponent()
      ...
      this.PreRender += this.TWebUserControl_analysis_of_region_by_month_PreRender;
      }

    private void TWebUserControl_analysis_of_region_by_month_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_analysis_of_region_by_month Fresh()
      {
    ...
    private void Bind()
      {
      p.biz_coned_offering_rosters.BindBaseDataListForAnalysisOfRegionByMonth
        (
    ...
    } // end TWebUserControl_analysis_of_region_by_month
