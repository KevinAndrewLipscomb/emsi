<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_practitioner_status.ascx.cs" Inherits="UserControl_practitioner_status.TWebUserControl_practitioner_status"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new practitioner_status
</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
