<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_coned_sponsor.ascx.cs" Inherits="UserControl_coned_sponsor.TWebUserControl_coned_sponsor"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr runat="server" id="TableRow_id" visible="false">
  ...
  <tr>
    <td><font class="">Coned&nbsp;sponsor&nbsp;status:</font></td>
    <td>
      <asp:DropDownList ID="DropDownList_coned_sponsor_status" runat="server">
      </asp:DropDownList>
    </td>
    <td nowrap="nowrap">
      &nbsp;</td>
