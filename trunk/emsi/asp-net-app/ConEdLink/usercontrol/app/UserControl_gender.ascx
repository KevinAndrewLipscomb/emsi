<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_gender.ascx.cs" Inherits="UserControl_gender.TWebUserControl_gender"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new gender
</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
