...
namespace UserControl_analysis_of_sponsor_by_county
  {
  public partial class TWebUserControl_analysis_of_sponsor_by_county: ki_web_ui.usercontrol_class
    {
    public static class UserControl_analysis_of_sponsor_by_county_Static
      {
      public const int TCI_COUNTY = 0;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        ...
        for (var year = new k.subtype<int>(2013,DateTime.Today.Year + 1); year.val < year.LAST; year.val++)
          {
          DropDownList_year.Items.Insert
            (
            index:0,
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_coned_sponsor_binder_analysis_of_sponsor_binder_analysis_of_sponsor_by_county")
          {
          p.be_loaded &= ((Session["UserControl_coned_sponsor_binder_UserControl_analysis_of_sponnsor_binder_PlaceHolder_content"] as string) == "UserControl_analysis_of_sponsor_by_county");
          }
        }
      else
        {
    ...
    private void InitializeComponent()
      ...
      this.PreRender += this.TWebUserControl_analysis_of_sponsor_by_county_PreRender;
      }

    private void TWebUserControl_analysis_of_sponsor_by_county_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_analysis_of_sponsor_by_county Fresh()
      {
    ...
    private void Bind()
      {
      p.biz_coned_offering_rosters.BindBaseDataListForAnalysisOfSponsorByCounty
        (
      ...
      p.be_datagrid_empty = (p.num_counties == 0);
    ...
    } // end TWebUserControl_analysis_of_sponsor_by_county
