...
CREATE TABLE eligible_provider_equipment_list (
  ...
  allowable_cost decimal(10,2) unsigned default NULL,
  funding_level_nonrural decimal(10,2) unsigned default NULL,
  funding_level_rural decimal(10,2) unsigned default NULL,
  PRIMARY KEY  (`code`),
...
(33, 2, 'EKG monitor/defibrillator w/pacer', 5, 1, 1, 0, 0, 12000.00, 6000.00, 7200.00),
(34, 2, '12 lead EKG', 5, 1, 1, 0, 0, 20000.00, 10000.00, 12000.00),
(35, 2, 'AED', 5, 0, 0, 1, 1, 3500.00, 1750.00, 2100.00),
(36, 2, 'Oxygen system parts', 5, 1, 1, 1, 1, 500.00, 250.00, 300.00),
(37, 2, 'Capnography', 3, 1, 1, 0, 0, 3000.00, 1500.00, 1800.00),
(38, 2, 'CPAP', 5, 1, 1, 0, 0, 900.00, 450.00, 540.00),
(39, 2, 'Pulse oximeter', 5, 1, 1, 1, 0, 700.00, 350.00, 420.00),
(40, 2, 'Nitrous oxide delivery system', 5, 1, 1, 0, 0, 2000.00, 1000.00, 1200.00),
(41, 2, 'IV infusion pump', 5, 1, 1, 0, 0, 2000.00, 1000.00, 1000.00),
(42, 2, 'Intubation, durable', 5, 1, 1, 0, 0, 600.00, 300.00, 360.00),
(43, 2, 'Transtracheal jet insufflators', 5, 1, 1, 0, 0, 200.00, 100.00, 120.00),
(44, 2, 'Splinting/immobilization devices', 3, 1, 1, 1, 1, 500.00, 250.00, 300.00),
(45, 2, 'Stairchair', 5, 1, 0, 1, 0, 2650.00, 1325.00, 1590.00),
(46, 2, 'Stretcher, primary', 5, 1, 0, 1, 0, 11500.00, 5750.00, 6900.00),
...
(55, 2, 'Radio, portable (1/vehicle)', 5, 1, 1, 1, 1, 3000.00, 1500.00, 1800.00),
(56, 2, 'Triage vest set', 5, 1, 1, 1, 1, 150.00, 75.00, 90.00),
(57, 2, 'Triage system', 5, 1, 1, 1, 1, 500.00, 250.00, 300.00),
(58, 2, 'Alerting (up to 5)', 5, 1, 1, 1, 1, 400.00, 200.00, 240.00),
(59, 2, 'Vehicle safety monitoring system', 5, 1, 1, 1, 1, 3500.00, 1750.00, 2100.00),
(60, 2, 'PPE/turnout gear', 5, 1, 1, 1, 1, 1200.00, 600.00, 720.00),
(61, 2, 'Protective ballistic vest (over garment style)', 5, 1, 1, 1, 1, 1000.00, 500.00, 600.00),
(62, 2, 'Traffic safety', 5, 1, 1, 1, 1, 2500.00, 1250.00, 1500.00),
...
CREATE TABLE emsof_request_master (
  ...
  shortage decimal(10,2) unsigned NOT NULL default '0.00',
  ...
  be_reopened_after_going_to_state boolean NOT NULL DEFAULT '0',
  PRIMARY KEY  (id),
  KEY status_code (status_code),
