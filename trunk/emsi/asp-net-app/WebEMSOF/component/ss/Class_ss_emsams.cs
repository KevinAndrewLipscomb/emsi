...
#warning Safe_hint values should be tightened.
          coned_offering.class_id_1 = k.Safe(field_array[0],k.safe_hint_type.PUNCTUATED);
          coned_offering.class_type = k.Safe(field_array[1],k.safe_hint_type.PUNCTUATED);
          coned_offering.course_id = k.Safe(field_array[2],k.safe_hint_type.PUNCTUATED);
          coned_offering.class_number = k.Safe(field_array[3],k.safe_hint_type.PUNCTUATED);
          coned_offering.course_code = k.Safe(field_array[4],k.safe_hint_type.PUNCTUATED);
          coned_offering.created_by = k.Safe(field_array[5],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_created = k.Safe(field_array[6],k.safe_hint_type.PUNCTUATED);
          coned_offering.last_edited_by = k.Safe(field_array[7],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_last_edited = k.Safe(field_array[8],k.safe_hint_type.PUNCTUATED);
          coned_offering.sponsor_id = k.Safe(field_array[9],k.safe_hint_type.PUNCTUATED);
          coned_offering.sponsor_number = k.Safe(field_array[10],k.safe_hint_type.PUNCTUATED);
          coned_offering.training_ins_accred_num = k.Safe(field_array[11],k.safe_hint_type.PUNCTUATED);
          coned_offering.document_status = k.Safe(field_array[12],k.safe_hint_type.PUNCTUATED);
          coned_offering.class_final_status = k.Safe(field_array[13],k.safe_hint_type.PUNCTUATED);
          coned_offering.course_number = k.Safe(field_array[14],k.safe_hint_type.PUNCTUATED);
          coned_offering.location = k.Safe(field_array[15],k.safe_hint_type.PUNCTUATED);
          coned_offering.student_cost = k.Safe(field_array[16],k.safe_hint_type.PUNCTUATED);
          coned_offering.tuition_includes = k.Safe(field_array[17],k.safe_hint_type.PUNCTUATED);
          coned_offering.closed = k.Safe(field_array[18],k.safe_hint_type.PUNCTUATED);
          coned_offering.estimated_students = k.Safe(field_array[19],k.safe_hint_type.PUNCTUATED);
          coned_offering.start_date_time = k.Safe(field_array[20],k.safe_hint_type.PUNCTUATED);
          coned_offering.end_date_time = k.Safe(field_array[21],k.safe_hint_type.PUNCTUATED);
          ...
          coned_offering.verification_name = k.Safe(field_array[27],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_name = k.Safe(field_array[28],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_address_1 = k.Safe(field_array[29],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_address_2 = k.Safe(field_array[30],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_city = k.Safe(field_array[31],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_state = k.Safe(field_array[32],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_zip = k.Safe(field_array[33],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_daytime_phone = k.Safe(field_array[34],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_evening_phone = k.Safe(field_array[35],k.safe_hint_type.PUNCTUATED);
          coned_offering.contact_email = k.Safe(field_array[36],k.safe_hint_type.PUNCTUATED);
          coned_offering.public_contact_name = k.Safe(field_array[37],k.safe_hint_type.PUNCTUATED);
          coned_offering.public_contact_phone = k.Safe(field_array[38],k.safe_hint_type.PUNCTUATED);
          coned_offering.public_contact_email = k.Safe(field_array[39],k.safe_hint_type.PUNCTUATED);
          coned_offering.public_contact_website = k.Safe(field_array[40],k.safe_hint_type.PUNCTUATED);
          coned_offering.public_contact_notes = k.Safe(field_array[41],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_submitted_to_region = k.Safe(field_array[42],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_received_by_region = k.Safe(field_array[43],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_sponsor_notified = k.Safe(field_array[44],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_registration_sent_to_state = k.Safe(field_array[45],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_cards_sent_to_sponsor = k.Safe(field_array[46],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_materials_to_be_returned = k.Safe(field_array[47],k.safe_hint_type.PUNCTUATED);
          coned_offering.approved = k.Safe(field_array[48],k.safe_hint_type.PUNCTUATED);
          coned_offering.region_comments = k.Safe(field_array[49],k.safe_hint_type.PUNCTUATED);
          coned_offering.region_council_num = k.Safe(field_array[50],k.safe_hint_type.PUNCTUATED);
          coned_offering.class_county_code = k.Safe(field_array[51],k.safe_hint_type.PUNCTUATED);
          coned_offering.total_class_hours = k.Safe(field_array[52],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_address_1 = k.Safe(field_array[53],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_address_2 = k.Safe(field_array[54],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_city = k.Safe(field_array[55],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_state = k.Safe(field_array[56],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_zip = k.Safe(field_array[57],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_zip_plus_4 = k.Safe(field_array[58],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_phone = k.Safe(field_array[59],k.safe_hint_type.PUNCTUATED);
          coned_offering.location_email = k.Safe(field_array[60],k.safe_hint_type.PUNCTUATED);
          ...
          coned_offering.additional_texts = k.Safe(field_array[63],k.safe_hint_type.PUNCTUATED);
          coned_offering.final_registration_date = k.Safe(field_array[64],k.safe_hint_type.PUNCTUATED);
          coned_offering.offered_as_college_credit = k.Safe(field_array[65],k.safe_hint_type.PUNCTUATED);
          coned_offering.practical_exam_date = k.Safe(field_array[66],k.safe_hint_type.PUNCTUATED);
          coned_offering.written_exam_date = k.Safe(field_array[67],k.safe_hint_type.PUNCTUATED);
          coned_offering.disapproval_reason_id = k.Safe(field_array[68],k.safe_hint_type.PUNCTUATED);
          coned_offering.date_final_paperwork_received = k.Safe(field_array[69],k.safe_hint_type.PUNCTUATED);
          coned_offering.signed_hard_copy = k.Safe(field_array[70],k.safe_hint_type.PUNCTUATED);
          coned_offering.created_by_first_name = k.Safe(field_array[71],k.safe_hint_type.PUNCTUATED);
          coned_offering.created_by_last_name = k.Safe(field_array[72],k.safe_hint_type.PUNCTUATED);
          coned_offering.class_disapproval_reason_description = k.Safe(field_array[73],k.safe_hint_type.PUNCTUATED);
          coned_offering.class_final_status_description = k.Safe(field_array[74],k.safe_hint_type.PUNCTUATED);
          coned_offering.sponsor_name = k.Safe(field_array[75],k.safe_hint_type.PUNCTUATED);
          coned_offering.courses_course_number = k.Safe(field_array[76],k.safe_hint_type.PUNCTUATED);
          coned_offering.course_title = k.Safe(field_array[77],k.safe_hint_type.PUNCTUATED);
          coned_offering.cert_course_code = k.Safe(field_array[78],k.safe_hint_type.PUNCTUATED);
          coned_offering.cert_course_description = k.Safe(field_array[79],k.safe_hint_type.PUNCTUATED);
          coned_offering.class_id_2 = k.Safe(field_array[80],k.safe_hint_type.PUNCTUATED);
