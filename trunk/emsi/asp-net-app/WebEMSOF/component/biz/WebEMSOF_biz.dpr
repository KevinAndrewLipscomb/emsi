...
uses
  ...
  Class_biz_accounts in 'Class_biz_accounts.pas',
  Class_biz_appropriations in 'Class_biz_appropriations.pas',
  Class_biz_emsof_requests in 'Class_biz_emsof_requests.pas',
  Class_biz_fiscal_years in 'Class_biz_fiscal_years.pas',
  Class_biz_user in 'Class_biz_user.pas';
