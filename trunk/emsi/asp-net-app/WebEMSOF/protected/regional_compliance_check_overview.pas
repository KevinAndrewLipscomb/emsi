...
type TWebForm_regional_compliance_check_overview = class(System.Web.UI.Page)
  ...
  strict private
    ...
    procedure TWebForm_regional_compliance_check_overview_PreRender(sender: System.Object;
      e: System.EventArgs);
  {$ENDREGION}
  strict private
    p: p_type;
...
begin
  ...
  Include(Self.PreRender, Self.TWebForm_regional_compliance_check_overview_PreRender);
end;
{$ENDREGION}
...
procedure TWebForm_regional_compliance_check_overview.TWebForm_regional_compliance_check_overview_PreRender(sender: System.Object;
  e: System.EventArgs);
begin
  session.Remove('p');
  session.Add('p',p);
