...
<table bordercolor="#dcdcdc" cellspacing="0" cellpadding="10" width="100%" border="1">
  <tr>
    <td bgcolor="#f5f5f5">
      <strong><ASP:LinkButton id="LinkButton_analyses" runat="server">Analyses</ASP:LinkButton></strong>
    </td>
  </tr>
</table>
                  <p>
    ...
    <td>
      <table cellspacing="0" cellpadding="10" width="100%" border="0">
        ...
        <tr>
          <td>
            <ul>
              <li><p><ASP:LinkButton id="LinkButton_maintain_service_accounts" runat="server" enabled="False">Maintain service accounts</ASP:LinkButton></p></li>
              <li><p><ASP:LinkButton id="LinkButton_maintain_county_accounts" runat="server" enabled="False">Maintain county coordinator accounts</ASP:LinkButton></p></li>
              <li><p><ASP:LinkButton id="LinkButton_maintain_regional_staffer_accounts" runat="server" enabled="False">Maintain regional staffer accounts</ASP:LinkButton></p></li>
              <li><p><ASP:LinkButton id="LinkButton_maintain_charter_kinds" runat="server">Maintain charter kinds</ASP:LinkButton></p></li>
            </ul>
          </td>
        </tr>
      </table>
