...
<p>
          <ASP:DataGrid id="DataGrid_county_dictated_appropriation_join" runat="server" datasource="<%# bdr_service_appropriations %>" bordercolor="#CCCCCC" borderstyle="None" borderwidth="1px" backcolor="White" cellpadding="5" gridlines="Horizontal" forecolor="Black" allowsorting="True" useaccessibleheader="True" autogeneratecolumns="False">
