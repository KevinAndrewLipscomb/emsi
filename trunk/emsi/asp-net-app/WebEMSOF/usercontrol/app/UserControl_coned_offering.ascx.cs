...
#warning Safe_hint values should be tightened.
          ...
          k.Safe(TextBox_created_by.Text,k.safe_hint_type.HUMAN_NAME).Trim(),
          UserControl_drop_down_date_date_created.selectedvalue,
          k.Safe(TextBox_last_edited_by.Text,k.safe_hint_type.HUMAN_NAME).Trim(),
          ...
          k.Safe(TextBox_location.Text,k.safe_hint_type.PUNCTUATED).Trim(),
          ...
          k.Safe(TextBox_start_time.Text,k.safe_hint_type.DATE_TIME).Trim(),
          k.Safe(TextBox_end_time.Text,k.safe_hint_type.DATE_TIME).Trim(),
          ...
          k.Safe(TextBox_additional_texts.Text,k.safe_hint_type.PUNCTUATED).Trim(),
          ...
          k.Safe(TextBox_class_final_status_description.Text,k.safe_hint_type.PUNCTUATED).Trim(),
          k.Safe(TextBox_sponsor_name.Text,k.safe_hint_type.PUNCTUATED).Trim(),
