...
namespace UserControl_charter_kind
{
    public partial class TWebUserControl_charter_kind: ki_web_ui.usercontrol_class
    {
    private p_type p; // Private Parcel of Page-Pertinent Process-Persistent Parameters
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        Literal_match_index.Text = DropDownList_spec.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_charter_kinds.Get(id, out description))
            {
                TextBox_id.Text = id;
        ...
        {
            PreRender += TWebUserControl_charter_kind_PreRender;
        }
        ...
        public TWebUserControl_charter_kind Fresh()
        {
            TWebUserControl_charter_kind result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_charter_kinds.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_charter_kinds.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
    ...
    } // end TWebUserControl_charter_kind
