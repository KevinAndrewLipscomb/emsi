...
<asp:GridView id="GridView_control" runat="server" gridlines="Horizontal" cellpadding="10" autogeneratecolumns="False" allowsorting="True" emptydatatext="No data available">
                      <Columns>
                        ...
                        <asp:BoundField datafield="emsof_part" dataformatstring="{0:C}" headertext="EMSOF portion" htmlencode="False" sortexpression="emsof_part%">
                          <ItemStyle horizontalalign="Right"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField datafield="overall_cost" dataformatstring="{0:C}" headertext="Overall cost" htmlencode="False" sortexpression="overall_cost%">
                          <ItemStyle horizontalalign="Right"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField datafield="avg_unit_cost" dataformatstring="{0:C}" headertext="Average unit cost" htmlencode="False" sortexpression="avg_unit_cost%">
                          <ItemStyle horizontalalign="Right"></ItemStyle>
                        </asp:BoundField>
                      </Columns>
