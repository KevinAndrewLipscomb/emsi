...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td valign="top">
      ...
      <ASP:DropDownList id="DropDownList_name" runat="server" visible="False" autopostback="True" onselectedindexchanged="DropDownList_name_SelectedIndexChanged"></ASP:DropDownList><br>
    </td>
    <td valign="top">
