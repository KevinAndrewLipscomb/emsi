<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_equipment_procurement_binder.ascx.cs" Inherits="UserControl_equipment_procurement_binder.TWebUserControl_equipment_procurement_binder"%>
