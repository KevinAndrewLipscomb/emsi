<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_teaching_entity_level.ascx.cs" Inherits="UserControl_teaching_entity_level.TWebUserControl_teaching_entity_level"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new teaching entity level
</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
