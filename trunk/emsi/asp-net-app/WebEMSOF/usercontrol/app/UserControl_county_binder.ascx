<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_county_binder.ascx.cs" Inherits="UserControl_county_binder.TWebUserControl_county_binder"%>
      ...
      <tr>
        <td>
          <cc1:TabContainer id="TabContainer_control" runat="server" autopostback="True" cssclass="ajax__tab_ki">
            ...
            <cc1:TabPanel runat="server" headertext="Available allocations" id="TabPanel_available_allocations"></cc1:TabPanel>
          </cc1:TabContainer>
        </td>
      </tr>
      <tr>
