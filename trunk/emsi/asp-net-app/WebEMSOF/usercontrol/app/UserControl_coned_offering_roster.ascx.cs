...
namespace UserControl_coned_offering_roster
  {
  public partial class TWebUserControl_coned_offering_roster: ki_web_ui.usercontrol_class
    {
    ...
    private void Clear()
      ...
      TextBox_coned_offering_id.Text = k.EMPTY;
      TextBox_practitioner_id.Text = k.EMPTY;
      TextBox_instructor_hours.Text = k.EMPTY;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_coned_offering_rosters;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
#warning Remove the following line if the coned_offering_roster will primarily be a reference table as opposed to a log or journal table.
        SetDataEntryMode();
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/coned_offering_roster/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_coned_offering_rosters.Get
          (
          id,
        ...
        TextBox_coned_offering_id.Text = coned_offering_id;
        TextBox_practitioner_id.Text = practitioner_id;
        TextBox_instructor_hours.Text = instructor_hours;
        ...
        Button_delete.Enabled = p.be_ok_to_config_coned_offering_rosters;
        result = true;
        }
      return result;
      }
...
#warning Revise the following line if the usercontrol will not be a direct child of the member binder.
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_coned_offering_roster");
        }
      else
        {
        p.be_loaded = false;
        ...
        p.be_ok_to_config_coned_offering_rosters = k.Has((string[])(Session["privilege_array"]), "config-coned_offering_rosters");
        }
      }
    ...
    public TWebUserControl_coned_offering_roster Fresh()
      {
...
#warning Safe_hint values should be tightened.
          k.Safe(TextBox_coned_offering_id.Text,k.safe_hint_type.PUNCTUATED).Trim(),
          k.Safe(TextBox_practitioner_id.Text,k.safe_hint_type.PUNCTUATED).Trim(),
          k.Safe(TextBox_instructor_hours.Text,k.safe_hint_type.PUNCTUATED).Trim()
          );
...
#warning Review safe-hint and tighten if necessary
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_coned_offering_rosters.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      {
      TextBox_coned_offering_id.Enabled = ablement;
      TextBox_practitioner_id.Enabled = ablement;
      TextBox_instructor_hours.Enabled = ablement;
      }
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_coned_offering_rosters.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_coned_offering_roster
