...
begin
  ...
  if session['UserControl_equipment_procurement_overview.p'] <> nil then begin
    ...
    p.be_loaded := IsPostBack and (string(session['UserControl_analyses_binder_control_UserControl_equipment_procurement_binder_PlaceHolder_content']) = 'UserControl_equipment_procurement_overview');
  end else begin
    //
