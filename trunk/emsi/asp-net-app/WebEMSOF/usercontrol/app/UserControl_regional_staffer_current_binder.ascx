<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_regional_staffer_current_binder.pas" Inherits="UserControl_regional_staffer_current_binder.TWebUserControl_regional_staffer_current_binder"%>
