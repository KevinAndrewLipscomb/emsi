<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_charter_kind.ascx.cs" Inherits="UserControl_charter_kind.TWebUserControl_charter_kind"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new Charter kind</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
              </table>
