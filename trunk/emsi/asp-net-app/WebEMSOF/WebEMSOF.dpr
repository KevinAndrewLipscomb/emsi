...
{%File 'testdata.sql'}
{%DelphiDotNetAssemblyCompiler 'c:\documents and settings\administrator\my documents\sandbox\kveo-it-project\foundation\dotnet\ki\ki.dll'}
{%DelphiDotNetAssemblyCompiler 'component\db\WebEMSOF_db.dll'}
{%DelphiDotNetAssemblyCompiler 'component\biz\WebEMSOF_biz.dll'}
