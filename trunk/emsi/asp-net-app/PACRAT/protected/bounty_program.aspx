...
<body bgcolor="white">
  ...
  <p>The submitter:</p>
  <ul>
    <li>Must be a current employee or member in good standing (ie, not suspended or undergoing investigation or corrective action) of a Pennsylvania Health Department EMS Bureau regulated entity (except those described below),
      or a past employee or member of such entity who was not fired or dismissed</li>
    <li>Must not be employed by Kalips'o Infogistics LLC directly or indirectly, nor be a paid employee of the Pennsylvania Health Department EMS Bureau or of any of Pennsylvania's regional EMS councils</li>
  </ul>
  <p>&nbsp;</p>
  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        <li>[None registered at this time]</li>
      </ul>
    </li>
  </ul>
  <p>&nbsp;</p>
