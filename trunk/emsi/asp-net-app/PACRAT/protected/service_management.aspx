  ...
  <body id="Body_control" runat="server" bgcolor="white">
    <form runat="server" defaultfocus="TextBox_practitioner">
      ...
      <asp:UpdatePanel ID="UpdatePanel_overall" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
          <asp:CheckBox ID="CheckBox_be_strike_team_participant" runat="server" AutoPostBack="True" Text="Participant" oncheckedchanged="CheckBox_be_strike_team_participant_CheckedChanged" />
                        ...
                        <tr>
                          <td>
                            <table cellpadding="5" cellspacing="0">
                              <tr><td colspan="3"><b><asp:Literal ID="Literal_service_name" runat="server"></asp:Literal></b></td></tr>
                              <tr>
