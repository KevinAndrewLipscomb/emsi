<%@ Control Language="c#" AutoEventWireup="True" CodeBehind="UserControl_strike_team_deployment_member_policy.ascx.cs" Inherits="UserControl_strike_team_deployment_member_policy.TWebUserControl_strike_team_deployment_member_policy" %>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td valign="middle">
                    <small><asp:LinkButton ID="LinkButton_new_record" runat="server" CausesValidation="False" Visible="False" OnClick="LinkButton_new_record_Click">Enter brand new strike_team_deployment_member_policy</asp:LinkButton></small>
                  </td>
                </tr>
              </table>
              <table>
