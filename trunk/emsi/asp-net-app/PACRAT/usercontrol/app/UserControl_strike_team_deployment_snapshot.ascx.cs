...
namespace UserControl_strike_team_deployment_snapshot
  ...
  public partial class TWebUserControl_strike_team_deployment_snapshot: ki_web_ui.usercontrol_class
    ...
    protected void DataGrid_assignments_ItemDataBound(object sender, DataGridItemEventArgs e)
      ...
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.ASSIGNMENTS_CI_VEHICLE].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.ASSIGNMENTS_CI_MEMBER_DESIGNATOR].Text + "</Data></Cell>"
      + "</Row>";
      }
    ...
    protected void DataGrid_digest_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
      ...
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.DIGEST_CI_VEHICLE].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.DIGEST_CI_VEHICLE_PATIENT_CARE_LEVEL_ID].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.DIGEST_CI_KIND].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.DIGEST_CI_PAR].Text + "</Data></Cell>"
      + "</Row>";
      }
    ...
    protected void DataGrid_log_ItemDataBound(object sender, DataGridItemEventArgs e)
      ...
      p.log_content_xml +=
        "<Row>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.LOG_CI_TIMESTAMP].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.LOG_CI_ACTOR].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.LOG_CI_ACTION].Text + "</Data></Cell>"
      + "</Row>";
      }
    ...
    protected void DataGrid_personnel_ItemDataBound(object sender, DataGridItemEventArgs e)
      ...
      p.personnel_content_xml +=
        "<Row>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.PERSONNEL_CI_TAG_NUM].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.PERSONNEL_CI_LAST_NAME].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.PERSONNEL_CI_FIRST_NAME].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.PERSONNEL_CI_LEVEL].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.PERSONNEL_CI_AFFILIATION].Text + "</Data></Cell>"
      + "</Row>";
      }
    ...
    protected void DataGrid_vehicles_ItemDataBound(object sender, DataGridItemEventArgs e)
      ...
      p.vehicles_content_xml +=
        "<Row>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_TACTICAL_NAME].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_TRANSPONDER_NAME].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_SERVICE].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_NAME].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_LEVEL].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_KIND].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_DECAL_NUM].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_TOW_CAPACITY].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_FUEL].Text + "</Data></Cell>"
      +   "<Cell><Data>" + e.Item.Cells[UserControl_strike_team_deployment_snapshot_Static.VEHICLES_CI_BE_AWD].Text + "</Data></Cell>"
      + "</Row>";
      }
    ...
    protected void Button_export_Click(object sender, System.EventArgs e)
      ...
      var raw_xml = k.EMPTY
        ...
        +   "<ss:Worksheet ss:Name=\"Digest\"><Table>" + p.digest_content_xml + "</Table></ss:Worksheet>"
        +   "<ss:Worksheet ss:Name=\"Assignments\"><Table>" + p.assignments_content_xml + "</Table></ss:Worksheet>"
        +   "<ss:Worksheet ss:Name=\"Log\"><Table>" + p.log_content_xml + "</Table></ss:Worksheet>"
        + "</Workbook>";
      ExportToExcel
        (
        the_page:Page,
