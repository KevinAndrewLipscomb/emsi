...
namespace UserControl_strike_team_deployment_member
  {
  public partial class TWebUserControl_strike_team_deployment_member: ki_web_ui.usercontrol_class
    {
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_strike_team_deployment_members;
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_strike_team_deployment_members.Get
          (
          id,
          out deployment_id,
          out practitioner_id
        ...
        SetDependentFieldAblements(p.be_ok_to_config_strike_team_deployment_members);
        Button_submit.Enabled = p.be_ok_to_config_strike_team_deployment_members;
        Button_delete.Enabled = p.be_ok_to_config_strike_team_deployment_members;
        result = true;
        }
      return result;
      }
...
#warning Revise the following line if the usercontrol will not be a direct child of the member binder.
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_strike_team_deployment_member");
        }
      else
        {
        p.be_loaded = false;
        ...
        p.be_ok_to_config_strike_team_deployment_members = k.Has((string[])(Session["privilege_array"]), "config-strike_team_deployment_members");
        }
      }
    ...
    public TWebUserControl_strike_team_deployment_member Fresh()
      {
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_strike_team_deployment_members.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_strike_team_deployment_members.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_strike_team_deployment_member
