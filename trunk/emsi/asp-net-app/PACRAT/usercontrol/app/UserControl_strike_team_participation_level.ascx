<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_strike_team_participation_level.ascx.cs" Inherits="UserControl_strike_team_participation_level.TWebUserControl_strike_team_participation_level"%>
...
<table cellspacing="0" cellpadding="5" width="100%" border="0">
  ...
  <tr>
    ...
    <td valign="top">
      <font class="">
        <ASP:TextBox id="TextBox_elaboration" runat="server" columns="72" textmode="MultiLine" rows="6" cssclass="" enabled="False"></ASP:TextBox>
      </font>
    </td>
    <td nowrap="nowrap" valign="top">
      ...
      <ASP:RegularExpressionValidator id="RegularExpressionValidator_elaboration" runat="server" errormessage="Please restrict the Elaboration entry to 65535 characters." font-bold="True" controltovalidate="TextBox_elaboration" validationexpression="^[\s\S]{0,65535}$">!ERR!</ASP:RegularExpressionValidator>
    </td>
  </tr>
      </table>
    </td>
