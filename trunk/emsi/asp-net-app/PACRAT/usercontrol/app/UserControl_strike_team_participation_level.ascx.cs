...
namespace UserControl_strike_team_participation_level
  {
  public partial class TWebUserControl_strike_team_participation_level: ki_web_ui.usercontrol_class
    {
    private struct p_type
      ...
      public bool be_ok_to_config_strike_team_participation_levels;
      public string id;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_strike_team_participation_levels;
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_strike_team_participation_levels.Get
          (
          id,
          out description,
          out pecking_order,
        ...
        SetDependentFieldAblements(p.be_ok_to_config_strike_team_participation_levels);
        Button_submit.Enabled = p.be_ok_to_config_strike_team_participation_levels;
        Button_delete.Enabled = p.be_ok_to_config_strike_team_participation_levels;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_member_binder_config_binder_business_objects_binder_strike_team_participation_level")
          {
          p.be_loaded &= ((Session["UserControl_member_binder_UserControl_config_binder_PlaceHolder_content"] as string) == "UserControl_strike_team_participation_level");
          }
//      else if (instance_id == "ASP.~_aspx.UserControl_~_binder_strike_team_participation_level")
//        {
//        p.be_loaded &= ((Session["UserControl_~_binder_PlaceHolder_content"] as string) == "UserControl_strike_team_participation_level");
//        }
        }
      else
        {
        ...
        //
        p.be_loaded = false;
        p.be_ok_to_config_strike_team_participation_levels = k.Has((string[])(Session["privilege_array"]), "config-strike-team-participation-levels");
        p.id = k.EMPTY;
    ...
    public TWebUserControl_strike_team_participation_level Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_strike_team_participation_levels.Set
          (
          k.Safe(TextBox_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_description.Text,k.safe_hint_type.HYPHENATED_ALPHA).Trim(),
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_strike_team_participation_levels.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_strike_team_participation_levels.Bind(saved_id, DropDownList_id);
    ...
    internal void SetP
      ...
      if (id.Length > 0)
        {
        p.id = id;
        p.summary = p.biz_strike_team_participation_levels.Summary(id);
        p.presentation_mode = (p.be_ok_to_config_strike_team_participation_levels ? presentation_mode_enum.FULL_FUNCTION : p.presentation_mode = presentation_mode_enum.REVIEW_ONLY);
        }
      else
        {
        p.id = k.EMPTY;
    ...
    } // end TWebUserControl_strike_team_participation_level
