  ...
  public partial class TWebUserControl_region_affiliation: ki_web_ui.usercontrol_class
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_preparation_binder_PlaceHolder_content"] as string) == "UserControl_region_affiliation");
        }
      else
        {
    ...
    private void InitializeComponent()
      ...
      this.PreRender += this.TWebUserControl_region_affiliation_PreRender;
      //this.Load += this.Page_Load;
      }

    private void TWebUserControl_region_affiliation_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_region_affiliation Fresh()
      {
    ...
    private void Bind()
      {
      p.biz_regions.BindStrikeTeamAffiliationBaseDataList
        (
    ...
    } // end TWebUserControl_region_affiliation
