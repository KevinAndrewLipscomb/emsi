...
using Class_biz_any_service_role_member_map;
...
namespace UserControl_any_service_role_member_map
  {
  public partial class TWebUserControl_any_service_role_member_map: ki_web_ui.usercontrol_class
    {
    private struct p_type
      {
      public bool be_loaded;
      public TClass_biz_any_service_role_member_map biz_any_service_role_member_map;
      public TClass_biz_role_member_map biz_role_member_map;
      public bool be_ok_to_config_any_service_role_member_map;
      } // end p_type
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_any_service_role_member_map;
        LinkButton_go_to_match_first.Text = k.ExpandTildePath(LinkButton_go_to_match_first.Text);
        LinkButton_go_to_match_prior.Text = k.ExpandTildePath(LinkButton_go_to_match_prior.Text);
        LinkButton_go_to_match_next.Text = k.ExpandTildePath(LinkButton_go_to_match_next.Text);
        LinkButton_go_to_match_last.Text = k.ExpandTildePath(LinkButton_go_to_match_last.Text);
        RequireConfirmation(Button_delete, "Are you sure you want to delete this record?");
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/any_service_role_member_map/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        (
        p.biz_any_service_role_member_map.Get
          (
          id,
          out service_id,
          out role_id,
        ...
        TextBox_role_id.Text = role_id;
        TextBox_member_id.Text = member_id;
        Button_lookup.Enabled = false;
        Label_lookup_arrow.Enabled = false;
        Label_lookup_hint.Enabled = false;
        LinkButton_reset.Enabled = true;
        SetDependentFieldAblements(p.be_ok_to_config_any_service_role_member_map);
        Button_submit.Enabled = p.be_ok_to_config_any_service_role_member_map;
        Button_delete.Enabled = p.be_ok_to_config_any_service_role_member_map;
        result = true;
        }
      return result;
      }
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_any_service_role_member_map");
        }
      else
        {
        p.be_loaded = false;
        p.biz_any_service_role_member_map = new TClass_biz_any_service_role_member_map();
        p.biz_role_member_map = new TClass_biz_role_member_map();
        p.be_ok_to_config_any_service_role_member_map = k.Has((string[])(Session["privilege_array"]), "config-any_service_role_member_map");
        }
      }
    ...
    private void InitializeComponent()
      ...
      this.PreRender += this.TWebUserControl_any_service_role_member_map_PreRender;
      }

    private void TWebUserControl_any_service_role_member_map_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_any_service_role_member_map Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_any_service_role_member_map.Set
          (
          k.Safe(TextBox_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_service_id.Text,k.safe_hint_type.NUM).Trim(),
          k.Safe(TextBox_role_id.Text,k.safe_hint_type.NUM).Trim(),
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_any_service_role_member_map.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    private void SetDependentFieldAblements(bool ablement)
      ...
      TextBox_role_id.Enabled = ablement;
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_any_service_role_member_map.Bind(saved_id, DropDownList_id);
    ...
    } // end TWebUserControl_any_service_role_member_map
