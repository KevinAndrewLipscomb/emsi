...
namespace UserControl_static_region_strike_team_key_personnel
  ...
  public partial class TWebUserControl_static_region_strike_team_key_personnel: ki_web_ui.usercontrol_class
    ...
    private class UserControl_static_region_strike_team_key_personnel_Static
      {
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        Literal_region_name.Text = p.biz_regions.NameOf(p.region_summary);
...
//        }
    ...
    protected void DataGrid_control_ItemDataBound(object sender, DataGridItemEventArgs e)
      ...
      if (new ArrayList {ListItemType.AlternatingItem,ListItemType.Item,ListItemType.EditItem,ListItemType.SelectedItem}.Contains(e.Item.ItemType))
        {
        var label_email_address = (e.Item.Cells[UserControl_static_region_strike_team_key_personnel_Static.TCI_EMAIL_ADDRESS].FindControl("Label_email_address") as Label);
        if (label_email_address.Text == "DESIRED")
          {
          label_email_address.ForeColor = Color.DarkOrange;
          }
        //
        if (!(new ArrayList {"Active","Probation","Suspended"}).Contains(e.Item.Cells[UserControl_static_region_strike_team_key_personnel_Static.TCI_STATUS_DESCRIPTION].Text))
          {
