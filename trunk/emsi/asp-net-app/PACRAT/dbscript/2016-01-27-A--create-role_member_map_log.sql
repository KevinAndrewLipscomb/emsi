...
CREATE TABLE `role_member_map_log`
  ...
  ,
    KEY `role_id` (`role_id`)
  ,
    CONSTRAINT `role_member_map_log_subject_member_id` FOREIGN KEY (`subject_member_id`) REFERENCES `associate` (`id`)
  ,
    CONSTRAINT `role_member_map_log_actor_member_id` FOREIGN KEY (`actor_member_id`) REFERENCES `associate` (`id`)
  ,
