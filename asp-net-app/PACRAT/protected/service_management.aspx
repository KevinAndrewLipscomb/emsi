...
<%@ Page language="c#" Debug="true" Codebehind="service_management.aspx.cs" AutoEventWireup="True" Inherits="service_management.TWebForm_service_management" %>
  ...
  <body id="Body_control" runat="server" bgcolor="white">
    <form runat="server" defaultfocus="TextBox_practitioner">
      ...
      <asp:UpdatePanel ID="UpdatePanel_overall" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
          <asp:CheckBox ID="CheckBox_be_strike_team_participant" runat="server" AutoPostBack="True" Text="Participating service" oncheckedchanged="CheckBox_be_strike_team_participant_CheckedChanged" />
                        ...
                        <tr>
                          <td>
                            <table cellpadding="5" cellspacing="0">
                              <tr><td colspan="3"><b><asp:Literal ID="Literal_service_name" runat="server"></asp:Literal> <i>Strike Team</i></b></td></tr>
                              <tr>
                                <td nowrap="nowrap" valign="top"><b>PA DOH Affiliate #:</b></td>
                                <td nowrap="nowrap" valign="top"><asp:Literal ID="Literal_affiliate_num" runat="server"></asp:Literal></td>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel_assignees" runat="server" UpdateMode="Conditional">
                              <ContentTemplate>
                                <table cellpadding="10" cellspacing="0">
                                  ...
                                  <tr><td><asp:LinkButton ID="LinkButton_drill_down" runat="server" Font-Bold="True" onclick="LinkButton_drill_down_Click">DRILL DOWN</asp:LinkButton></td></tr>
                                  <tr>
                                    <td>
