...
<%@ Page language="c#" Debug="true" Codebehind="state_detail.aspx.cs" AutoEventWireup="True" Inherits="state_detail.TWebForm_state_detail" %>
...
<html>
  ...
  <body bgcolor="white">
    <form runat="server">
      ...
      <uc2:UserControl_state_detail ID="UserControl_state_detail1" runat="server" />
