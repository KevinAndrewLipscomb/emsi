  ...
  <tr>
    <td>
      <table align="center" cellpadding="10" cellspacing="0">
        ...
        <tr><td align="center"><big><b><asp:Literal ID="Literal_application_name" runat="server"></asp:Literal> Resource Assignment Report # <asp:Literal ID="Literal_ref_num" runat="server"></asp:Literal></b></big></td></tr>
