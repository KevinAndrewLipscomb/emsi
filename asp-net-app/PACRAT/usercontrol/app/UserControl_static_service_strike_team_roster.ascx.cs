...
namespace UserControl_static_service_strike_team_roster
  ...
  public partial class TWebUserControl_static_service_strike_team_roster: ki_web_ui.usercontrol_class
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        Literal_service_name.Text = p.biz_services.NameOfSummary(p.summary);
        Literal_affiliate_num.Text = p.biz_services.AffiliateNumOf(p.summary);
        Bind();
        p.be_loaded = true;
        }
      }
...
//        }
    ...
    private void Bind()
      ...
      p.biz_strike_team_rosters.BindBaseDataListByServiceId
        ...
        id:p.biz_services.IdOf(p.summary)
        );
