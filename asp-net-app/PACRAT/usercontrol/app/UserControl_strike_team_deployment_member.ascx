<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_strike_team_deployment_member.ascx.cs" Inherits="UserControl_strike_team_deployment_member.TWebUserControl_strike_team_deployment_member"%>
