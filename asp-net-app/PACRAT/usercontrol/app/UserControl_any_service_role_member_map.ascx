<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_any_service_role_member_map.ascx.cs" Inherits="UserControl_any_service_role_member_map.TWebUserControl_any_service_role_member_map"%>
