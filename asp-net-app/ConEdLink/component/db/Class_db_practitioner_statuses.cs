...
namespace Class_db_practitioner_statuses
  ...
  public class TClass_db_practitioner_statuses: TClass_db
    ...
    public void BindDirectToListControl
      ...
      Open();
      var dr = new MySqlCommand("SELECT id,description FROM practitioner_status where description <> '(none specified)' order by id", connection).ExecuteReader();
      while (dr.Read())
        {
    ...
    public bool Delete(string id)
      ...
      try
        {
        new MySqlCommand(db_trail.Saved("delete from practitioner_status where id = '" + id + "'"), connection).ExecuteNonQuery();
        }
    ...
    public bool Get
      ...
      var result = false;
      Open();
      var dr = new MySqlCommand("select description from practitioner_status where id = '" + id + "'", connection).ExecuteReader();
      if (dr.Read())
        {
