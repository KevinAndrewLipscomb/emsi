...
using Class_biz_teaching_entity_business_types;
using Class_biz_teaching_entity_levels;
using kix;
using System;
using System.Web;
using System.Web.UI;
...
namespace UserControl_coned_sponsor
  {
  public partial class TWebUserControl_coned_sponsor: ki_web_ui.usercontrol_class
    {
    private struct p_type
      ...
      public TClass_biz_teaching_entity_business_types biz_teaching_entity_business_types;
    ...
    private void Clear()
      ...
      DropDownList_business_type.ClearSelection();
      DropDownList_con_ed_level.ClearSelection();
      ...
      DropDownList_coned_sponsor_status.ClearSelection();
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        ...
        p.biz_teaching_entity_business_types.BindDirectToListControl(DropDownList_business_type);
        p.biz_teaching_entity_levels.BindDirectToListControl(DropDownList_con_ed_level);
        ...
        if ((Session["mode:goto"] != null) && Session["mode:goto"].ToString().Contains("/coned_sponsor/"))
          {
    ...
    private bool PresentRecord(string id)
      ...
      if
        ...
        DropDownList_region.SelectedValue = region;
        ...
        DropDownList_business_type.SelectedValue = business_type_id;
        DropDownList_con_ed_level.SelectedValue = con_ed_level_id;
        ...
        DropDownList_coned_sponsor_status.SelectedValue = coned_sponsor_status_id;
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[InstanceId() + ".p"] != null)
        ...
        p.be_loaded = IsPostBack && ((Session["UserControl_regional_staffer_binder_UserControl_config_binder_PlaceHolder_content"] as string) == "UserControl_coned_sponsor");
        }
      else
        {
        p.be_loaded = false;
        ...
        p.biz_teaching_entity_business_types = new TClass_biz_teaching_entity_business_types();
        p.biz_teaching_entity_levels = new TClass_biz_teaching_entity_levels();
        }
      }
    ...
    public TWebUserControl_coned_sponsor Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        ...
        p.biz_teaching_entities.Set
          ...
          k.Safe(TextBox_emsrs_id.Text,k.safe_hint_type.NUM),
          UserControl_drop_down_date_date_created.selectedvalue,
          UserControl_drop_down_date_date_last_edited.selectedvalue,
          k.Safe(TextBox_sponsor_number.Text,k.safe_hint_type.HYPHENATED_NUM),
          k.EMPTY,
          ...
          k.Safe(TextBox_state.Text,k.safe_hint_type.ALPHA),
          k.Safe(TextBox_zip.Text,k.safe_hint_type.HYPHENATED_NUM),
          ...
          k.Safe(TextBox_email.Text,k.safe_hint_type.EMAIL_ADDRESS),
          k.Safe(TextBox_website.Text,k.safe_hint_type.HTTP_TARGET),
          ...
          k.Safe(DropDownList_business_type.SelectedValue,k.safe_hint_type.NUM),
          k.Safe(DropDownList_con_ed_level.Text,k.safe_hint_type.NUM),
          k.EMPTY,
          ...
          k.Safe(TextBox_contact_state.Text,k.safe_hint_type.ALPHA),
          k.Safe(TextBox_contact_zip.Text,k.safe_hint_type.HYPHENATED_NUM),
          ...
          k.Safe(TextBox_contact_email.Text,k.safe_hint_type.EMAIL_ADDRESS),
          ...
          k.Safe(TextBox_public_contact_email.Text,k.safe_hint_type.EMAIL_ADDRESS),
          k.Safe(TextBox_public_contact_website.Text,k.safe_hint_type.HTTP_TARGET),
          ...
          k.Safe(DropDownList_coned_sponsor_status.SelectedValue,k.safe_hint_type.NUM),
          k.EMPTY,
    ...
    private void SetDependentFieldAblements(bool ablement)
      ...
      DropDownList_business_type.Enabled = ablement;
      DropDownList_con_ed_level.Enabled = ablement;
      ...
      DropDownList_coned_sponsor_status.Enabled = ablement;
    ...
    internal void SetTarget(string target)
      {
      PresentRecord(target.Substring(target.LastIndexOf("/") + 1));
      }

    } // end TWebUserControl_coned_sponsor
