  ...
  public partial class TWebUserControl_analysis_of_region_by_course: ki_web_ui.usercontrol_class
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_regional_staffer_binder_analysis_binder_analysis_of_region_by_course")
          {
          p.be_loaded &= ((Session["UserControl_regional_staffer_binder_UserControl_analysis_binder_PlaceHolder_content"] as string) == "UserControl_analysis_of_region_by_course");
          }
        }
      else
        {
