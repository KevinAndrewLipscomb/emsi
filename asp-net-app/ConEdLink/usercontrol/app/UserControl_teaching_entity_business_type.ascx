<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_teaching_entity_business_type.ascx.cs" Inherits="UserControl_teaching_entity_business_type.TWebUserControl_teaching_entity_business_type"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new teaching entity business type
</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
