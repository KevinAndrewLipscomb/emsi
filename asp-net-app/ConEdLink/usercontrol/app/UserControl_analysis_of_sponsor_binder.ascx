<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_analysis_of_sponsor_binder.ascx.cs" Inherits="UserControl_analysis_of_sponsor_binder.TWebUserControl_analysis_of_sponsor_binder"%>
