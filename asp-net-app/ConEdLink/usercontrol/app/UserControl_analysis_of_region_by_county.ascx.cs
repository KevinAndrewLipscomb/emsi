...
namespace UserControl_analysis_of_region_by_county
  {
  public partial class TWebUserControl_analysis_of_region_by_county: ki_web_ui.usercontrol_class
    {
    public static class UserControl_analysis_of_region_by_county_Static
      {
    ...
    protected override void OnInit(System.EventArgs e)
      ...
      if (Session[instance_id + ".p"] != null)
        ...
        //
        if (instance_id == "ASP.protected_overview_aspx.UserControl_regional_staffer_binder_analysis_binder_analysis_of_region_by_county")
          {
          p.be_loaded &= ((Session["UserControl_regional_staffer_binder_UserControl_analysis_binder_PlaceHolder_content"] as string) == "UserControl_analysis_of_region_by_county");
          }
        }
      else
        {
    ...
    public TWebUserControl_analysis_of_region_by_county Fresh()
      {
    ...
    private void Bind()
      {
      p.biz_coned_offering_rosters.BindBaseDataListForAnalysisOfRegionByCounty
        (
    ...
    } // end TWebUserControl_analysis_of_region_by_county
