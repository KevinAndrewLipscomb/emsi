...
namespace UserControl_coned_offering_status
{
    // Derived from KiAspdotnetFramework/UserControl/app/UserControl~template~trivial~item.pas
    public partial class TWebUserControl_coned_offering_status: ki_web_ui.usercontrol_class
    {
        private p_type p;
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_coned_offering_statuses;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_coned_offering_statuses.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                SetDependentFieldAblements(p.be_ok_to_config_coned_offering_statuses);
                Button_submit.Enabled = p.be_ok_to_config_coned_offering_statuses;
                Button_delete.Enabled = p.be_ok_to_config_coned_offering_statuses;
                result = true;
            }
            return result;
        }
        ...
        private void SetLookupMode()
        {
            ...
            LinkButton_new_record.Enabled = p.be_ok_to_config_coned_offering_statuses;
            TextBox_id.Focus();
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_coned_offering_status");
            }
            else
            {
                p.be_loaded = false;
                p.biz_coned_offering_statuses = new TClass_biz_coned_offering_statuses();
                p.be_ok_to_config_coned_offering_statuses = k.Has((string[])(Session["privilege_array"]), "config-coned_offering_statuses");
            }
        ...
        {
            this.PreRender += this.TWebUserControl_coned_offering_status_PreRender;
            //this.Load += this.Page_Load;
        }

        private void TWebUserControl_coned_offering_status_PreRender(object sender, System.EventArgs e)
        {
            SessionSet(InstanceId() + ".p", p);
        }

        public TWebUserControl_coned_offering_status Fresh()
        {
            TWebUserControl_coned_offering_status result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_coned_offering_statuses.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_coned_offering_statuses.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_coned_offering_statuses.Bind(saved_id, DropDownList_code);
        ...
        private struct p_type
        {
            ...
            public bool be_ok_to_config_coned_offering_statuses;
            public TClass_biz_coned_offering_statuses biz_coned_offering_statuses;
        } // end p_type

    } // end TWebUserControl_coned_offering_status
