    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        ...
        p.biz_coned_offerings.Set
          ...
          k.Safe(TextBox_class_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_course_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_class_number.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_created_by.Text,k.safe_hint_type.NUM),
          UserControl_drop_down_date_date_created.selectedvalue,
          k.Safe(TextBox_last_edited_by.Text,k.safe_hint_type.NUM),
          UserControl_drop_down_date_date_last_edited.selectedvalue,
          k.Safe(TextBox_sponsor_id.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_sponsor_number.Text,k.safe_hint_type.HYPHENATED_NUM),
          k.Safe(DropDownList_document_status.SelectedValue,k.safe_hint_type.ALPHA),
          k.Safe(DropDownList_class_final_status.SelectedValue,k.safe_hint_type.NUM),
          k.Safe(TextBox_course_number.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_location.Text,k.safe_hint_type.POSTAL_STREET_ADDRESS).Trim(),
          k.Safe(TextBox_student_cost.Text,k.safe_hint_type.CURRENCY_USA),
          k.Safe(TextBox_tuition_includes.Text,k.safe_hint_type.PUNCTUATED).Trim(),
          CheckBox_closed.Checked,
          k.Safe(TextBox_estimated_students.Text,k.safe_hint_type.NUM),
          ...
          k.Safe(DropDownList_region_council.SelectedValue,k.safe_hint_type.NUM),
          k.Safe(DropDownList_class_county.SelectedValue,k.safe_hint_type.NUM),
          k.Safe(TextBox_total_class_hours.Text,k.safe_hint_type.REAL_NUM),
          ...
          k.Safe(TextBox_location_state.Text,k.safe_hint_type.ALPHA),
          k.Safe(TextBox_location_zip.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_location_zip_plus_4.Text,k.safe_hint_type.NUM),
          k.Safe(TextBox_location_phone.Text,k.safe_hint_type.PHONE_NUM).Trim(),
          k.Safe(TextBox_location_email.Text,k.safe_hint_type.EMAIL_ADDRESS),
          ...
          k.Safe(TextBox_additional_texts.Text,k.safe_hint_type.NUM),
          ...
          k.Safe(TextBox_disapproval_reason_id.Text,k.safe_hint_type.NUM),
