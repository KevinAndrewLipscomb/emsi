...
namespace UserControl_eval_summary_mode
  {

  public partial class TWebUserControl_eval_summary_mode: ki_web_ui.usercontrol_class
    {

    private struct p_type
      {
      public bool be_loaded;
      public bool be_ok_to_config_eval_summary_modes;
    ...
    protected void Page_Load(object sender, System.EventArgs e)
      ...
      if (!p.be_loaded)
        {
        LinkButton_new_record.Visible = p.be_ok_to_config_eval_summary_modes;
    ...
    private bool PresentRecord(string id)
      ...
      //
        ...
        SetDependentFieldAblements(p.be_ok_to_config_eval_summary_modes);
        Button_submit.Enabled = p.be_ok_to_config_eval_summary_modes;
        Button_delete.Enabled = p.be_ok_to_config_eval_summary_modes;
        result = true;
        }
      return result;
      }
    ...
    private void SetLookupMode()
      ...
      LinkButton_new_record.Enabled = p.be_ok_to_config_eval_summary_modes;
      TextBox_id.Focus();
      }
...
#warning Revise the binder-related instance_id to this control appropriately.
        if (instance_id == "ASP.protected_overview_aspx.UserControl_member_binder_eval_summary_mode")
          {
#warning Revise the ClientID path to this control appropriately.
          p.be_loaded &= ((Session["UserControl_member_binder_PlaceHolder_content"] as string) == "UserControl_eval_summary_mode");
          }
//      else if (instance_id == "ASP.~_aspx.UserControl_~_binder_eval_summary_mode")
//        {
//        p.be_loaded &= ((Session["UserControl_~_binder_PlaceHolder_content"] as string) == "UserControl_eval_summary_mode");
//        }
        }
      else
        {
        ...
        p.be_ok_to_config_eval_summary_modes = k.Has((string[])(Session["privilege_array"]), "config-eval_summary_modes");
        }
      }
    ...
    private void InitializeComponent()
      {
      PreRender += TWebUserControl_eval_summary_mode_PreRender;
      }

    private void TWebUserControl_eval_summary_mode_PreRender(object sender, System.EventArgs e)
      {
      SessionSet(InstanceId() + ".p", p);
      }

    public TWebUserControl_eval_summary_mode Fresh()
      {
    ...
    protected void Button_submit_Click(object sender, System.EventArgs e)
      ...
      if (Page.IsValid)
        {
        p.biz_eval_summary_modes.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
    ...
    protected void Button_delete_Click(object sender, System.EventArgs e)
      {
      if (p.biz_eval_summary_modes.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
        {
        SetLookupMode();
        }
      else
    ...
    protected void Button_lookup_Click(object sender, System.EventArgs e)
      ...
      if (!PresentRecord(saved_id))
        ...
        p.biz_eval_summary_modes.Bind(saved_id, DropDownList_code);
    ...
    } // end TWebUserControl_eval_summary_mode
