...
namespace UserControl_gender
{
    // Derived from KiAspdotnetFramework/UserControl/app/UserControl~template~trivial~item.pas
    public partial class TWebUserControl_gender: ki_web_ui.usercontrol_class
    {
        private p_type p;
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_genders;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_genders.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                SetDependentFieldAblements(p.be_ok_to_config_genders);
                Button_submit.Enabled = p.be_ok_to_config_genders;
                Button_delete.Enabled = p.be_ok_to_config_genders;
                result = true;
            }
            return result;
        }
        ...
        private void SetLookupMode()
        {
            ...
            LinkButton_new_record.Enabled = p.be_ok_to_config_genders;
            TextBox_id.Focus();
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_gender");
            }
            else
            {
                p.be_loaded = false;
                p.biz_genders = new TClass_biz_genders();
                p.be_ok_to_config_genders = k.Has((string[])(Session["privilege_array"]), "config-genders");
            }
        ...
        {
            this.PreRender += this.TWebUserControl_gender_PreRender;
            //this.Load += this.Page_Load;
        }

        private void TWebUserControl_gender_PreRender(object sender, System.EventArgs e)
        {
            SessionSet(InstanceId() + ".p", p);
        }

        public TWebUserControl_gender Fresh()
        {
            TWebUserControl_gender result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_genders.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_genders.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_genders.Bind(saved_id, DropDownList_code);
        ...
        private struct p_type
        {
            ...
            public bool be_ok_to_config_genders;
            public TClass_biz_genders biz_genders;
        } // end p_type

    } // end TWebUserControl_gender
