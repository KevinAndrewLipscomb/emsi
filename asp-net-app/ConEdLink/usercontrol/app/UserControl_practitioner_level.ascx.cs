    ...
    public partial class TWebUserControl_practitioner_level: ki_web_ui.usercontrol_class
    {
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_practitioner_levels;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_practitioner_levels.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                SetDependentFieldAblements(p.be_ok_to_config_practitioner_levels);
                Button_submit.Enabled = p.be_ok_to_config_practitioner_levels;
                Button_delete.Enabled = p.be_ok_to_config_practitioner_levels;
                result = true;
            }
            return result;
        }
        ...
        private void SetLookupMode()
        {
            ...
            LinkButton_new_record.Enabled = p.be_ok_to_config_practitioner_levels;
            TextBox_id.Focus();
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_practitioner_level");
            }
            else
            {
                p.be_loaded = false;
                p.biz_practitioner_levels = new TClass_biz_practitioner_levels();
                p.be_ok_to_config_practitioner_levels = k.Has((string[])(Session["privilege_array"]), "config-practitioner-levels");
            }
        ...
        public TWebUserControl_practitioner_level Fresh()
        {
            TWebUserControl_practitioner_level result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_practitioner_levels.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_practitioner_levels.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_practitioner_levels.Bind(saved_id, DropDownList_code);
        ...
        private struct p_type
        {
            ...
            public bool be_ok_to_config_practitioner_levels;
            public TClass_biz_practitioner_levels biz_practitioner_levels;
        } // end p_type

    } // end TWebUserControl_practitioner_level
