...
namespace UserControl_analysis_of_region_by_sponsor
  {
  public partial class TWebUserControl_analysis_of_region_by_sponsor: ki_web_ui.usercontrol_class
    {
    public static class UserControl_analysis_of_region_by_sponsor_Static
      {
      public const int TCI_SPONSOR_NUMBER = 0;
      public const int TCI_SPONSOR_NAME = 1;
    ...
    public TWebUserControl_analysis_of_region_by_sponsor Fresh()
      {
    ...
    private void Bind()
      {
      p.biz_coned_offering_rosters.BindBaseDataListForAnalysisOfRegionBySponsor
        (
      ...
      p.be_datagrid_empty = (p.num_sponsors == 0);
    ...
    } // end TWebUserControl_analysis_of_region_by_sponsor
