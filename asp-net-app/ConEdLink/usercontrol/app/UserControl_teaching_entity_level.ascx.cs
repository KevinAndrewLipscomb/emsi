...
namespace UserControl_teaching_entity_level
{
    // Derived from KiAspdotnetFramework/UserControl/app/UserControl~template~trivial~item.pas
    public partial class TWebUserControl_teaching_entity_level: ki_web_ui.usercontrol_class
    {
        private p_type p;
      ...
      LinkButton_go_to_match_first.Visible = false;
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!p.be_loaded)
            {
                LinkButton_new_record.Visible = p.be_ok_to_config_teaching_entity_levels;
        ...
        Literal_match_index.Text = DropDownList_code.SelectedIndex.ToString();
            ...
            string description;
            result = false;
            if (p.biz_teaching_entity_levels.Get(id, out description))
            {
                TextBox_id.Text = id;
                ...
                Button_delete.Enabled = p.be_ok_to_config_teaching_entity_levels;
                result = true;
            }
            return result;
        }
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            if (Session[InstanceId() + ".p"] != null)
            {
                ...
                p.be_loaded = IsPostBack && ((Session["UserControl_member_binder_UserControl_config_UserControl_business_objects_binder_PlaceHolder_content"] as string) == "UserControl_teaching_entity_level");
            }
            else
            {
                p.be_loaded = false;
                p.biz_teaching_entity_levels = new TClass_biz_teaching_entity_levels();
                p.be_ok_to_config_teaching_entity_levels = k.Has((string[])(Session["privilege_array"]), "config-teaching-entity-levels");
            }
        ...
        {
            this.PreRender += this.TWebUserControl_teaching_entity_level_PreRender;
            //this.Load += this.Page_Load;
        }

        private void TWebUserControl_teaching_entity_level_PreRender(object sender, System.EventArgs e)
        {
            SessionSet(InstanceId() + ".p", p);
        }

        public TWebUserControl_teaching_entity_level Fresh()
        {
            TWebUserControl_teaching_entity_level result;
        ...
        protected void Button_submit_Click(object sender, System.EventArgs e)
        {
            if (Page.IsValid)
            {
                p.biz_teaching_entity_levels.Set(k.Safe(TextBox_id.Text, k.safe_hint_type.NUM), k.Safe(TextBox_description.Text, k.safe_hint_type.PUNCTUATED));
        ...
        {
            if (p.biz_teaching_entity_levels.Delete(k.Safe(TextBox_id.Text, k.safe_hint_type.ALPHANUM)))
            {
                SetLookupMode();
            }
            else
        ...
        protected void Button_lookup_Click(object sender, System.EventArgs e)
        {
            ...
            if (!PresentRecord(saved_id))
            {
                ...
                p.biz_teaching_entity_levels.Bind(saved_id, DropDownList_code);
        ...
        private struct p_type
        {
            ...
            public bool be_ok_to_config_teaching_entity_levels;
            public TClass_biz_teaching_entity_levels biz_teaching_entity_levels;
        } // end p_type

    } // end TWebUserControl_teaching_entity_level
