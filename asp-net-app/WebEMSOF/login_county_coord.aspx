<%@ Page language="c#" Debug="true" Codebehind="login_county_coord.pas" AutoEventWireup="false" Inherits="login_county_coord.TWebForm_login_county_coord" %>
		  ...
		  <asp:placeholder id="PlaceHolder_precontent" runat="server">
			...
			<font color="red">
			  <ul id="invalid_credentials_warning" runat="server">
				<li>Invalid county/password combination. Please try again.</li>
			  </ul>
			</font>
			<table cellspacing="0" cellpadding="5">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
													<asp:textbox id="TextBox_password" runat="server" textmode="Password"></asp:textbox><ASP:RegularExpressionValidator id="RegularExpressionValidator_password" runat="server" errormessage='Please use only letters, numbers, and the underscore ("_") character (or local equivalents) in your password.' font-bold="True" validationexpression="\w+" controltovalidate="TextBox_password">!ERR!</ASP:RegularExpressionValidator>
											         </td>
                </tr>
                <tr>
                  <td>
