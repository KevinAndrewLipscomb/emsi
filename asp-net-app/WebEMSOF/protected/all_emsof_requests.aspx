            ...
            <tr>
              <td>
                <table cellspacing="0" cellpadding="10" border="0">
                    <tr>
					  <td bgcolor="#f5f5f5"><strong>All EMSOF requests in current workflow (<ASP:Label id="Label_num_datagrid_rows" runat="server"></ASP:Label>)</strong>&nbsp; <uc1:UserControl_print_div id="UserControl_print_div" runat="server"></uc1:UserControl_print_div>
</td>
					</tr>
