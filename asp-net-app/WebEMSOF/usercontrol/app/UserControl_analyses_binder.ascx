<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_analyses_binder.ascx.cs" Inherits="UserControl_analyses_binder.TWebUserControl_analyses_binder"%>
