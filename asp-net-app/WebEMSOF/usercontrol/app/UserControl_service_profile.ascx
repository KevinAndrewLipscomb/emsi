...
<br>
<ASP:Button id="Button_submit" text="SUBMIT profile for Annual Survey" runat="server"></ASP:Button>&nbsp;&nbsp;<ASP:Button id="Button_delete" text="Delete" runat="server" enabled="False"></ASP:Button>
