<%@ Control Language="c#" AutoEventWireup="false" Codebehind="UserControl_regional_staffer_current_binder.ascx.cs" Inherits="UserControl_regional_staffer_current_binder.TWebUserControl_regional_staffer_current_binder"%>
