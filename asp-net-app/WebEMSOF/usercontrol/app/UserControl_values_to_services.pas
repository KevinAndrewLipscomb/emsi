unit UserControl_values_to_services;
...
type
  p_type =
    ...
    sort_order: string;
    END;
  TWebUserControl_values_to_services = class(ki_web_ui.usercontrol_class)
  {$REGION 'Designer Managed Code'}
  strict private
    procedure InitializeComponent;
    procedure TWebUserControl_values_to_services_PreRender(sender: System.Object;
      e: System.EventArgs);
  ...
  public
    { Public Declarations }
  published
    function Fresh: TWebUserControl_values_to_services;
  end;
...
procedure TWebUserControl_values_to_services.InjectPersistentClientSideScript;
begin
...
procedure TWebUserControl_values_to_services.Page_Load(sender: System.Object; e: System.EventArgs);
begin
  //
...
procedure TWebUserControl_values_to_services.OnInit(e: System.EventArgs);
begin
  //
...
/// </summary>
procedure TWebUserControl_values_to_services.InitializeComponent;
begin
  Include(Self.GridView_control.Sorting, Self.GridView_control_Sorting);
  Include(Self.PreRender, Self.TWebUserControl_values_to_services_PreRender);
  Include(Self.Load, Self.Page_Load);
end;
{$ENDREGION}

procedure TWebUserControl_values_to_services.TWebUserControl_values_to_services_PreRender(sender: System.Object;
  e: System.EventArgs);
begin
  SessionSet('UserControl_values_to_services.p',p);
end;

function TWebUserControl_values_to_services.Fresh: TWebUserControl_values_to_services;
begin
  session.Remove('UserControl_values_to_services.p');
  Fresh := self;
end;

procedure TWebUserControl_values_to_services.GridView_control_Sorting(sender: System.Object;
...
procedure TWebUserControl_values_to_services.Bind;
begin
