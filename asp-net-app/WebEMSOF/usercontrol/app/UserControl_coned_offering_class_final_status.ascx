<%@ Control Language="c#" AutoEventWireup="True" Codebehind="UserControl_coned_offering_class_final_status.ascx.cs" Inherits="UserControl_coned_offering_class_final_status.TWebUserControl_coned_offering_class_final_status"%>
            ...
            <font class="compact">
              <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr>
                  ...
                  <td valign="middle">
                    <small>
                      <ASP:LinkButton id="LinkButton_new_record" runat="server" causesvalidation="False" visible="False" onclick="LinkButton_new_record_Click">Enter brand new coned offering class final status
</ASP:LinkButton>
                    </small>
                  </td>
                </tr>
