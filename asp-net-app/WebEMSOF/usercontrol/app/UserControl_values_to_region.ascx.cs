...
namespace UserControl_values_to_region
{
    ...
    public partial class TWebUserControl_values_to_region: ki_web_ui.usercontrol_class
    {
        ...
        protected override void OnInit(System.EventArgs e)
        {
            ...
            InitializeComponent();
            base.OnInit(e);
            if (Session["UserControl_values_to_region.p"] != null)
            {
                p = (p_type)(Session["UserControl_values_to_region.p"]);
        ...
        {
            SessionSet("UserControl_values_to_region.p", p);
        }

        public TWebUserControl_values_to_region Fresh()
        {
            TWebUserControl_values_to_region result;
            Session.Remove("UserControl_values_to_region.p");
            result = this;
            return result;
        }
        ...
        private void Bind()
        {
            p.biz_emsof_requests.BindValuesToRegion(p.sort_order, p.be_sort_order_ascending, GridView_control);
        }

    } // end TWebUserControl_values_to_region
