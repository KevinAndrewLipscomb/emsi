...
begin
  ...
  if session['UserControl_equipment_procurement_binder.p'] <> nil then begin
    ...
    p.be_loaded := IsPostBack and (string(session['UserControl_regional_staffer_binder_control_UserControl_analyses_binder_PlaceHolder_content']) = 'UserControl_equipment_procurement_binder');
    //
...
procedure TWebUserControl_equipment_procurement_binder.TabContainer_control_ActiveTabChanged(sender: System.Object;
  e: System.EventArgs);
begin
  //
