...
<asp:GridView id="GridView_control" runat="server" gridlines="Horizontal" cellpadding="10" autogeneratecolumns="False" allowsorting="True" emptydatatext="No data available">
  <Columns>
    ...
    <asp:BoundField datafield="emsof" dataformatstring="{0:c}" headertext="EMSOF contributions" sortexpression="emsof%">
      <ItemStyle horizontalalign="Right"></ItemStyle>
    </asp:BoundField>
    <asp:BoundField datafield="service_contributions" dataformatstring="{0:c}" headertext="Service contributions" sortexpression="service_contributions%">
      <ItemStyle horizontalalign="Right"></ItemStyle>
    </asp:BoundField>
    <asp:BoundField datafield="costs" dataformatstring="{0:c}" headertext="Total" sortexpression="costs%">
