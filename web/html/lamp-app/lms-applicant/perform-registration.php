...
<table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
   <tr>
      <td>
         <table>
            <tr>
               <td><img align="center" valign="middle" src="http://www.emsi.org/images/emsi-logo.JPG"></td>
               <td>
            ...
            // then
               ...
               if ($assert_email_address or BeValidEmailAddress($email_address,$mode))
                  ...
                  if ($found_valid_rec["value"])
                     ...
                     if ($result)
                        ...
                        echo "<ul>\n"
                           ...
                           . "</ul>\n"
                           . "<p>Problems?&nbsp; Contact <a href=mailto:education@emsi.org><i>education@emsi.org</i></a>.</p>\n";
                        }
                     else
                        {
                     ...
                     <blockquote>
                        ...
                        <ul>
                           ...
                           <li>
                              ...
                              <p><small>To see which counties EMSI serves, see <a href=http://www.emsi.org>EMSI's home
                                 page.</a></small></p>
                           </li>
                        </ul>
                     </blockquote>            
                  ...
                  echo "<h2><i>Warning!</i></h2>\n"
                     ...
                     . "      <form method=post action=http://www.emsi.org/lamp-app/lms-applicant/" . $mode . "perform-registration.php>\n"
